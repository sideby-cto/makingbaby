...
const pagination_input_1 = require("../share/types/pagination-input");
let UserController = class UserController {
    ...
    findAll(currentPage, pageSize, filter) {
        return this.userService.findAll(new pagination_input_1.PaginationInput(currentPage, pageSize, filter));
    }
    async findOne(id) {
