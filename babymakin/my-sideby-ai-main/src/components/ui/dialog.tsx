...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-[99999] bg-background/80 backdrop-blur-sm data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      className
    )}
    {...props}
  />
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // Mobile-specific improvements for better mobile experience with scrolling enabled
        "max-h-[100dvh] md:max-h-[90vh] overflow-y-auto",
        "p-0 sm:p-6",
        "mx-0 sm:mx-0",
        "top-0 left-0 right-0 bottom-0 translate-x-0 translate-y-0 rounded-none",
        "sm:top-[50%] sm:left-[50%] sm:right-auto sm:bottom-auto sm:translate-x-[-50%] sm:translate-y-[-50%] sm:rounded-lg",
        "sm:max-w-4xl sm:w-full sm:h-auto",
        className
      )}
      {...props}
    >
